...
class Demodulator extends Transform {
  ...
  constructor(options={}){
    ...
    options.sampleRate  = options.sampleRate  || 44100;
    options.window      = options.window      || 35;
  ...
  demodulate(frequencyData){
    ...
    if(greatest == frequencies[0]) this.bitStream.writeBits(0,1);
    if(greatest == frequencies[1]) this.bitStream.writeBits(1,1);
  }
